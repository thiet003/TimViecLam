...
public class ExperienceAdapter extends RecyclerView.Adapter<ExperienceAdapter.ExperienceViewHolder>{
    ...
    public class ExperienceViewHolder extends RecyclerView.ViewHolder {
        ...
        public ExperienceViewHolder(@NonNull View itemView) {
            super(itemView);
            company = itemView.findViewById(R.id.experience_company);
            time = itemView.findViewById(R.id.experience_time);
            service = itemView.findViewById(R.id.experience_service);
            detail = itemView.findViewById(R.id.experience_detail);
        }
    }
}
