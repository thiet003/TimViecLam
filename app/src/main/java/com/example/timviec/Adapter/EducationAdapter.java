...
public class EducationAdapter extends RecyclerView.Adapter<EducationAdapter.EducationViewHolder>{
    ...
    public class EducationViewHolder extends RecyclerView.ViewHolder {
        ...
        public EducationViewHolder(@NonNull View itemView) {
            super(itemView);
            school = itemView.findViewById(R.id.education_school);
            time = itemView.findViewById(R.id.education_time);
            degree = itemView.findViewById(R.id.education_degree);
            detail = itemView.findViewById(R.id.education_detail);
        }
    }
