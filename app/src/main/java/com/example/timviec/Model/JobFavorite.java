...
@Entity(tableName = "jobFavorite")
public class JobFavorite implements Serializable {
    @PrimaryKey(autoGenerate = true)
    private int id;

    public JobFavorite(String link, String resourceId, String name, String salary, String address, String company, String updateTime) {
        this.link = link;
